...
export default function Urls({
    ...
    return (
        <>
            <Head title={canManageUrls ? 'My URLs' : 'Shorten URL'} />
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
                ...
                <div className="rounded-xl border border-sidebar-border/70 p-6">
                    ...
                    {latestShortCode !== null && (
                        <div className="mt-4 rounded-md border border-sidebar-border/70 bg-muted/40 p-4">
                            <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
                                Your short URL
                            </p>
                            <p className="mt-1 font-mono text-sm">{window.location.origin}/{latestShortCode}</p>
                        </div>
                    )}
                </div>
                ...
                {!canManageUrls && (
                    <p className="text-sm text-muted-foreground">
                        Sign in to keep a private history and manage your shortened URLs.
                    </p>
                )}
            </div>
        </>
...
Urls.layout = {
    breadcrumbs: [{ title: 'Shorten URL', href: index() }],
};
